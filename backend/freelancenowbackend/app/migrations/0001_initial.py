# Generated by Django 5.1.1 on 2024-11-01 22:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('created', 'Created'), ('in_progress', 'In Progress'), ('completed', 'Completed'), ('canceled', 'Canceled'), ('freelancer_interested', 'Freelancer Interested'), ('company_interested', 'Company Interested'), ('rejected', 'Rejected'), ('undefined', 'Undefined')], default='undefined', max_length=50)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.project')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('freelancer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='app.freelancer')),
            ],
        ),
