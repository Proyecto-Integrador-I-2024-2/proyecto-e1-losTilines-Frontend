# Generated by Django 5.1.1 on 2024-09-30 00:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='uploads/')),
                ('status', models.CharField(blank=True, null=True, verbose_name=app.models.ProjectStatus)),
                ('profile_picture', models.URLField(blank=True, null=True)),
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.area')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owner_project', to='app.company')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
